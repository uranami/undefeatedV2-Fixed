...
public:
	void InitialiseSDK()
	{
		...
		pInput = (CInput*)*(DWORD*)(Utils.FindPatternIDA("client_panorama.dll", "B9 ? ? ? ? F3 0F 11 04 24 FF 50 10") + 1);//B9 ? ? ? ? F3 0F 11 04 24 FF 50 10 ] + 1Utils.PFindPattern("client.dll", "E8 ? ? ? ? 84 C0 74 08 8B C6");
