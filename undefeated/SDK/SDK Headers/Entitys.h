...
public:
	...
	int* GetItemDefinitionIndex()
	{
		...
		static short m_iItemDefinitionIndex = Netvar("DT_BaseAttributableItem", "m_AttributeManager", "m_Item", "m_iItemDefinitionIndex");
	...
	void CBaseCombatWeapon::UpdateAccuracyPenalty() {
		...
		getvfunc<OriginalFn>(this, 468)(this);//485 
	}
	...
	float CBaseCombatWeapon::GetInaccuracy() {
		...
		return getvfunc<OriginalFn>(this, 467)(this);//483 
	}
	...
	float CBaseCombatWeapon::GetSpread() {
		if (!this)
			return 0.f;
		typedef float(__thiscall* OriginalFn)(void*);
		return getvfunc<OriginalFn>(this, 436)(this);//484 
	}
	float CBaseCombatWeapon::GetWeaponCone() {
		if (!this)
			return 0.f;
		typedef float(__thiscall* OriginalFn)(void*);
		return getvfunc<OriginalFn>(this, 475)(this);
	}
	...
	bool IsGun()
	{
		...
		if( id == WEAPON_KNIFE || id == WEAPON_HEGRENADE || id == WEAPON_DECOY || id == WEAPON_INC || id == WEAPON_MOLOTOV || id == WEAPON_C4 || id == WEAPON_ZEUSX27 || id == WEAPON_FLASHBANG || id == WEAPON_SMOKEGRENADE)
			return false;
		else
			return true;
	}
